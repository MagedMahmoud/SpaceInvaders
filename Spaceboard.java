...
public class Spaceboard extends JPanel implements Runnable, Attributes { 
	    ...
	    public Spaceboard() 
	    {
	        ...
	        setFocusable(true);
	        img = Toolkit.getDefaultToolkit().createImage("C:\\Users\\Maged\\Desktop\\Code Shop\\Java\\Spaceinvaders\\space1.png"); 
	        ...
	        public void gameInit() {
	            ...
	            for (int i=0; i < 4; i++) {
	            	for (int j=0; j < 6; j++) {
	    	            ...
	    	            ImageIcon  a= new ImageIcon ("C:\\Users\\Maged\\Desktop\\Code Shop\\Java\\Spaceinvaders\\alien"+randomNum+".png","Alienship");	        	            		
